...
**For Mac**
1. Change lines 40, 41 and 43 to a burner email for test cases and learning purposes only
...
3. In DecryptFile.py on line 4 add the key from GenerateKey.py
4. Run code as is
...
3. Change lines 40, 41 and 43 to a burner email for test cases and learning purposes only
...
5. In DecryptFile.py on line 4 add the key from GenerateKey.py
